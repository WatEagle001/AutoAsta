                    ...
                    if($biglietti != null){
                        ...
                        foreach($biglietti as $biglietto){
                            ...
                            $listaEventi .= '<img class="eventImg" alt="Immagine panoramica della citt&agrave; di '. basename($evento[0]['url_immagine'], ".jpg") .'" src="img/' . $evento[0]['url_immagine'] . '"/>' . 
                                ...
                                $listaEventi .='<a class="eventButton" aria-label="Elimina il biglietto per la fiera di ' .$evento[0]['citta'].'" href="delete_Ticket.php?Id_Biglietto='.$biglietto['Id_Biglietto'].'">Elimina Biglietto</a>';
