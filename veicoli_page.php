    ...
    if($connessioneOK){
        ...
        if($veicoli!= null){
            ...
            foreach($veicoli as $veicolo){
                ...
                <a role="link" aria-label="Ottieni maggiori informazioni riguardanti il veicolo ' .  $veicolo['marca'] . ' ' . $veicolo['modello'] . '" href="scheda_veicolo.php?Targa='.$veicolo['Targa'].'">APRI SCHEDA VEICOLO</a>
