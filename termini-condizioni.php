...
<html lang="it">
    <head>
        ...
        <title>Termini e Condizioni - Auto Asta</title>
        ...
        <meta name="keywords" content="termini, condizioni, accetta, cookie, privacy, policy"/>
    ...
    <body>
        ...
        <?php require_once ('header.php')?>
            <main> 
                <?php require_once('html/termini-condizioni.html')?>
            </main>   
